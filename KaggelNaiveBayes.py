...
rounds = 4
weight = []
sample_size = int(0.5 * trainfile_line_ctr)
w = 1.0/sample_size
#print("w = " + str(w))
...
for k in range(0, rounds):
    ...
    # print("sample class one = " + str(sample_class_one))
    # print("len(model_pos) = " + str(len(model_pos)))
    ...
    print("Predicted class list len = " + str(len(predicted_class_list)))
    hit_count = 0
    miss_count = 0
    error_Mi = 0
    ...
    print("Model pos length = " + str(len(model_pos)))
    print("Model pos length = " + str(len(model_pos)))

print("Outside Model pos length = " + str(len(model_pos)))
print(model_neg[0])
